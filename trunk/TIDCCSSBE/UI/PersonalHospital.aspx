        ...
        <div class="col-md-4">
             <div class="form-group">
                 <label class="control-label">Identificación</label>
                    <asp:TextBox runat="server" ID="txtCedulaFuncionario" CssClass="form-control" placeholder="Identificación del Usuario" Width="1387px" OnTextChanged="txtCedulaFuncionario_TextChanged" AutoPostBack="True"/>
            ...
            <div class="form-group">
                <label class="control-label">Primer Apellido</label>
                    <asp:TextBox runat="server" ID="txtApelli1" CssClass="form-control" placeholder="Primer Apellido del Usuario" Width="1387px"/>
            ...
            <div class="form-group">
                <label class="control-label">Segundo Apellido</label>
                    <asp:TextBox runat="server" ID="txtApelli2" CssClass="form-control" placeholder="Segundo Apellido del Usuario" Width="1387px" />
              ...
              <div class="form-group">
                  <label class="control-label">Nombre del Funcionario</label>              
                    <asp:TextBox runat="server" ID="txtNombPac" CssClass="form-control" placeholder="Nombre del Usuario" Width="1387px" /> 
        ...
        <div class="col-md-4">
             <div class="form-group">
                 <label class="control-label">Dirección completa</label> 
                    <asp:TextBox runat="server" ID="txtDirec"  CssClass="form-control" Rows="3" TextMode="MultiLine" Width="1387px"  placeholder="Dirección del Usuario" />
            ...
            <div class="form-group">
                <label class="control-label">Fecha de Nacimiento</label>                 
                    <asp:TextBox runat="server" ID="txtFecNac" CssClass="form-control" type="date" Width="1387px"/>
            ...
            <div class="form-group">
                <label class="control-label">Área de trabajo</label>                 
                    <asp:TextBox runat="server" ID="txtArea" CssClass="form-control" placeholder="Área de trabajo" Width="1387px"/>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="control-label">Contraseña</label>                 
                    <asp:TextBox runat="server" ID="txtPass" CssClass="form-control" placeholder="Contraseña" Width="1387px"/>
